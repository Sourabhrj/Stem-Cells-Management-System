...
$result = mysqli_query($mysqli, "SELECT * FROM STEM_CELLS_BANK ORDER BY SCB_NAME ASC"); 
?>

<html>
<head>	
<link href="cstyles.css" rel="stylesheet"/>
	<title>Stem cells bank </title>
</head>

<body>
<a href="stemcellsbankdonee.php">Add New Data</a><br/><br/>
	<diV class="container">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td bgcolor=''>".$res['SCB_NAME']."</td>";
